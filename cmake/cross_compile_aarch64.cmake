...
#
# If you want to force the library path to "lib64" then use the following. On the target,
# the installation happens under "lib64" and when cross-compiling it is picked as "lib".
# This behavior can be changed by setting the CMAKE_INSTALL_LIBDIR variable when cross-compiling
# to match the directory for target builds.
# cmake DCMAKE_INSTALL_LIBDIR=lib64 -DCMAKE_TOOLCHAIN_FILE=../cmake/cross_compile_aarch64.cmake ..
